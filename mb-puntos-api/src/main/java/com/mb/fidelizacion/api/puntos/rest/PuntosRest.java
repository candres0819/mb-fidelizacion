package com.mb.fidelizacion.api.puntos.rest;
...
import com.mb.fidelizacion.api.puntos.repository.ClienteDAO;

@RestController
@RequestMapping(path = "/puntos")
public class PuntosRest {
    ...
    @ResponseBody
    public String obtenerPuntosCliente(@RequestParam("email") String email) {
    ...
    public ResponseEntity<String> modificarPuntos(@RequestBody Cliente cliente) {
        ...
        if (cliente_modificado == null) {
            ...
            cliente_modificado
                    .setPuntos(Integer.toString(Integer.parseInt(cliente_modificado.getPuntos()) + Integer.parseInt(cliente.getPuntos())));
            // guardamos cambios
